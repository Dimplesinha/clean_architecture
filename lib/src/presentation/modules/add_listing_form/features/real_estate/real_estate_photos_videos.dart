...
/// @DATE : 10-10-2024
/// @Message : [RealEstatePhotosVideos]
///

class RealEstatePhotosVideos extends StatelessWidget {
  final AddListingFormCubit addListingFormCubit;
  final AddListingFormLoadedState state;

  const RealEstatePhotosVideos({super.key, required this.addListingFormCubit, required this.state});
        ...
        children: [
          ...
          LabelText(
            title: AddListingFormConstants.uploadUpToMsg.replaceAll(
              '{maxUploadCount}',
              AddListingFormUtils.getBusinessImagesMaximumCount(categoryName: state.category).toString(),
            ),
