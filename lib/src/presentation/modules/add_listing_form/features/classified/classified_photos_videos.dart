...
class ClassifiedPhotosVideosView extends StatelessWidget {
  final AddListingFormCubit addListingFormCubit;
  final AddListingFormLoadedState state;

  const ClassifiedPhotosVideosView({super.key, required this.addListingFormCubit, required this.state});

  @override
  Widget build(BuildContext context) {
    var maxMediaCount = AddListingFormUtils.getBusinessImagesMaximumCount(categoryName: state.category);
    state.businessLogo = state.formDataMap?[AddListingFormConstants.uploadHomePageLogo] ?? '';
    return Padding(
