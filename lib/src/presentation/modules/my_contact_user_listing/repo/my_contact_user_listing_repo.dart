...
/// @DATE : 27/03/25
/// @Message : [MyContactUserListingRepo]
///
...
class MyContactUserListingRepo {
  static final MyContactUserListingRepo _myListingRepo = MyContactUserListingRepo._internal();

  MyContactUserListingRepo._internal();

  static MyContactUserListingRepo get instance => _myListingRepo;
  ...
  Future<ResponseWrapper<MyListingResponse>?> fetchMyListingData({required Map<String, dynamic> requestBody}) async {
    try {
      ...
      ResponseWrapper response = await ApiClient.instance.postApiWithToken(
        path: ApiConstant.allActiveListing,
        userToken: token,
  ...
  /// Fetch Listing Data
  Future<ResponseWrapper<MyListingResponse>?> fetchMyPastListingData({
  ...
  Future<ResponseWrapper<void>> activityTracking({required Map<String, dynamic> requestBody}) async {
    try {
      ResponseWrapper response = await ApiClient.instance.postApi(path: ApiConstant.activityTracking, requestBody: requestBody);
