...
import 'package:workapp/src/domain/models/advance_search_model.dart' show AdvanceSearchItem;
...
class _RecentSearchTabState extends State<RecentSearchTab> {
  ...
  void initState() {
    ...
    widget.advanceSearchCubit.initSavedSearch(false);
    super.initState();
  }
  ...
  Widget _dismissibleCard(int index, AdvanceSearchItem item, AdvanceSearchLoadedState state) {
    ...
    return Padding(
      ...
      child: Dismissible(
        ...
        onDismissed: (direction) {
          ...
          widget.advanceSearchCubit.onDeleteClick(searchId: item.searchId, index: index, isSingleDelete: true);
        },
        child: InkWell(
          onTap: () {
                          ...
                          child: state.isEnableDeleteUI!
                              ? Checkbox(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                        color: item.isChecked == true ? AppColors.primaryColor : AppColors.borderColor),
                                  ),
